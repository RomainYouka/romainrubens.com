...
const initialThemeScript = `(function(){try{var t=localStorage.getItem('theme');if(t==='dark'){document.documentElement.setAttribute('data-theme','dark');var m=document.querySelector('meta[name="theme-color"]');if(m)m.setAttribute('content','#191919');}else{var m=document.querySelector('meta[name="theme-color"]');if(m)m.setAttribute('content','#ffffff');}var supported={blue:1,pink:1,green:1,orange:1,mono:1};var a=sessionStorage.getItem('accentColor');if(!a){var legacy=localStorage.getItem('accentColor');if(legacy&&supported[legacy]){a=legacy;sessionStorage.setItem('accentColor',legacy);}}localStorage.removeItem('accentColor');if(a&&supported[a]&&a!=='blue'){document.documentElement.setAttribute('data-accent',a);}else{sessionStorage.setItem('accentColor','blue');document.documentElement.removeAttribute('data-accent');}}catch(e){}})()`;
