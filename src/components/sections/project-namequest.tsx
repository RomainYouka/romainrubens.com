    ...
    >
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col-reverse md:flex-row md:items-stretch gap-0 md:gap-0">
          ...
          >
            <img
              src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/eeeeeeeeee-1762112535901.png?width=2000&height=2000&resize=contain"
      ...
      <div className="w-full bg-[#F5F5F7]">
        ...
        <div className="hidden md:block">
          <img
            src="/projects/namequest/ordinateur.png"
        ...
        <div className="md:hidden">
          <img
            src="/projects/namequest/mobile.png"
