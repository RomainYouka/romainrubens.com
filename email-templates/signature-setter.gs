...
function setSignature() {
  ...
  var signature =
    ...
    '<img class="sig-star" src="https://raw.githubusercontent.com/RomainYouka/romainrubens.com/cf97645/public/icons/logo-star-animated.gif"' +
    ...
    '<p class="sig-sub" style="margin:0;font-size:12px;color:#48484a;line-height:1.3;">UX/UI Designer &middot; Smart Ecosystems</p>' +
    '</td>' +
    '</tr>' +
